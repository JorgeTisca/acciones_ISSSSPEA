...
export default function PmpCancel({ id }: Props) {
  const sendNotification = async () => {
    const result = await Swal.fire({
      title: "Rechanzando solicitud ",
      text: "Escribe cuál fue la observación que notaste para rechazar esta solicitud",
      icon: "warning",
      input: "textarea",
    });
